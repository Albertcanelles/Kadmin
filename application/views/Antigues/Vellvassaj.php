...
<meta charset="utf-8">
    ...
    <body>
        ...
        <a href="" id="a<?php echo $llistarassajs['id_assajs'];?>" class="button left"> Assajs dia:<br><?php echo $llistarassajs['DiaHora'];?></a>

    <script>
    $(function() {
        $('#a<?php echo $llistarassajs['id_assajs'];?>').avgrund({
            height: 500,
            holderClass: 'custom',
            showClose: true,
            showCloseText: 'Tanca',
            ...
            template: '<p>Assajs: <?php echo $llistarassajs['Assajs'];?></p>' + '<p>Dia i Hora: <?php echo $llistarassajs['DiaHora'];?></p>' + '<p>Lloc: <?php echo $llistarassajs['Lloc'];?></p>' + '<p> Roba: <?php echo $llistarassajs['ProxActuacio'];?></p>' 
        });
    });
    </script>
    <?php } ?>
