                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div class="col-lg-12">
                              ...
                              <div class="row">
                    <div class="col-md-12"><h2>Perfil: <?$sesio = $this->session->userdata('logged_in');
                    $noom = $sesio['username'];
                    echo $noom; ?></h2>
                            ...
                            <div class="col-md-9">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="#" class="form-horizontal"><h3>Configuració del compte</h3><hr/>
                                            <div class="form-group"><label class="col-sm-3 control-label">Contrasenya</label>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Confirma la contrasenya</label>
                                            ...
                                            <hr/>
                                            <button type="submit" class="btn btn-green btn-block">Accepta</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
